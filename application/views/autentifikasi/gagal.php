...
<body id="page-top">
  ...
  <script src="<?= base_url('assets/'); ?>sb/vendor/bootstrap/js/bootstrap.bundle.min.j s"></script>
  <!-- Core plugin JavaScript -->
  <script src="<?= base_url('assets/'); ?>sb/vendor/jquery-easing/jquery.easing.min.j s"></script>

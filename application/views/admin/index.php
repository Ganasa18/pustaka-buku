...
<div class="container-fluid">
  ...
  <div class="row">
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="text-md font-weight-bold text-dark text-uppercase mb-1">Jumlah Anggota</div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-bottom-primary shadow h-100 py-2 bg-light">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-md font-weight-bold text-dark text-uppercase mb-1">Stok Buku Terdaftar</div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-bottom-success shadow h-100 py-2 bg-light">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-md font-weight-bold text-dark text-uppercase mb-1">Buku yang dipinjam</div>
              <div class="h1 mb-0 font-weight-bold text-dark">
                <?php
                $where = ['dipinjam != 0'];
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-bottom-danger shadow h-100 py-2 bg-light">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-md font-weight-bold text-dark text-uppercase mb-1">Buku yang dibooking</div>
              <div class="h1 mb-0 font-weight-bold text-dark">
                <?php
                $where = ['dibooking !=0'];
            ...
            <div class="col-auto">
              <a href="<?= base_url('user'); ?>"><i class="fas fa-clipboard-list fa-3x text-danger"></i></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              $jml = $query->num_rows();
              ?>
              <div class="text-md font-weight-bold text-light text-uppercase mb-1">Browser Chrome</div>
              <div class="h1 mb-0 font-weight-bold text-light">
                <?= $jml; ?>
              </div>
            </div>
            <div class="col-auto">
              <a href="#"><i class="fas fa fa-globe fa-3x text-light"></i></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card shadow h-100 py-2 bg-info">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <?php
              $query = $this->db->query("SELECT * FROM pengunjung WHERE pengunjung_perangkat='Edge'");
              $jml = $query->num_rows();
              ?>
              <div class="text-md font-weight-bold text-light text-uppercase mb-1">Browser Edge</div>
              <div class="h1 mb-0 font-weight-bold text-light">
                <?= $jml; ?>
              </div>
            </div>
      ...
      <div class="card shadow h-100 py-2 bg-warning">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <?php
              $query = $this->db->query("SELECT * FROM pengunjung WHERE pengunjung_perangkat='Safari'");
              $jml = $query->num_rows();
              ?>
              <div class="text-md font-weight-bold text-light text-uppercase mb-1">Browser Safari</div>
              <div class="h1 mb-0 font-weight-bold text-light">
                <?= $jml; ?>
              </div>
            </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              $jml = $query->num_rows();
              ?>
              <div class="text-md font-weight-bold text-light text-uppercase mb-1">Browser Opera</div>
              <div class="h1 mb-0 font-weight-bold text-light">
                <?= $jml; ?>
              </div>
            </div>
  ...
  <!-- row table-->
  <div class="row">
    <div class="table-responsive table-bordered col-sm-5 mt-2">
      <div class="page-header">
        <span class="fas fa-users text-primary mt-2 "> Data User</span>
        <a class="text-danger" href="<?= base_url('user/anggota'); ?>"><i class="fas fa-search mt-2 float-right"> Tampilkan</i></a>
      </div>
      <table class="table mt-3" id="table-datatable2">
        <thead>
          <tr>
            <th>#</th>
            <th>Nama Anggota</th>

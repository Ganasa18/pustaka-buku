...
<head>
  ...
  <link href="<?= base_url('assets/'); ?>sb/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet" type="text/css">
  <script type="text/javascript" src="<?= base_url('assets/'); ?>datatable/jquery.dataTables.js'; ?>"></script>
  <script type="text/javascript" src="<?= base_url('assets/'); ?>sb/vendor/datatable/dataTables.bootstrap4.min.js'; ?>"></script>

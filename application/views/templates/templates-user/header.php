...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>assets/sb/css/sb-admin-2.min.css">
  <link href="<?= base_url('assets/'); ?>sb/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link href="<?= base_url('assets/'); ?>sb/vendor/datatable/datatables.css" rel="stylesheet" type="text/css">
</head>
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          if (!empty($this->session->userdata('email'))) { ?>
            ...
            <a class="nav-item nav-link" href="<?= base_url('booking/info'); ?>">Booking Info</a>

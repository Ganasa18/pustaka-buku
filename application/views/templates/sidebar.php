...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  <!-- Sidebar - Brand --> <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('admin'); ?>">
    <fdiv class="sidebar-brand-icon rotate-n-15"> <i class="fas fa-book"></i> </fdiv>
  ...
  <li class="nav-item active">
    <!-- Nav Item - Dashboard -->
  <li class="nav-item">
    <a class="nav-link pb-3" href="<?= base_url('admin'); ?>">
  ...
  <li class="nav-item">
    <a class="nav-link pb-0" href="<?= base_url('laporan/laporan_pinjam'); ?>">
      <i class="fa fa-fw fa fa-address-book"></i>
      <span>Laporan Data Peminjam</span></a>
  </li>

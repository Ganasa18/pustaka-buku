  ...
  class Pinjam extends CI_Controller
  {
    ...
    public function ubahStatus()
    {
      ...
      $tgl = date('Y-m-d');
      $status = 'Kembali';
      $total = $this->input->post('totaldenda', TRUE);
      //update status menjadi kembali pada saat buku dikembalikan 
      $this->db->query("UPDATE pinjam, detail_pinjam SET pinjam.status='$status', pinjam.total_denda='$total' , pinjam.tgl_pengembalian='$tgl' WHERE detail_pinjam.id_buku='$id_buku' AND pinjam.no_pinjam='$no_pinjam'");

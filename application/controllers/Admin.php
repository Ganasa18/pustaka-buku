...
class Admin extends CI_Controller
{
  public function __construct()
  {
    ...
    $this->load->model(['ModelPengunjung', 'ModelBuku', 'ModelUser', 'ModelBooking']);
    // cek_login();
  }
  public function index()
  {
    ...
    $data['visitor'] = $this->ModelPengunjung->statistik_pengujung();
    //mengupdate stok dan dibooking pada tabel buku 
    $detail = $this->db->query("SELECT * FROM booking,booking_detail, buku 
    WHERE booking.id_booking = booking_detail.id_booking And booking_detail.id_buku=buku.id")->result_array();
